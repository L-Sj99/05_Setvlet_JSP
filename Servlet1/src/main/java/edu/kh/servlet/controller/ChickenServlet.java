...
public class ChickenServlet extends HttpServlet{
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		// 2) 값이 여러개인 경우 : String[] req.getParameterValues("name")
		// -> 제출된 값 중 name 속성 값이 일치하는 것을 모두 모아 하나의 "String[]"로 반환해주는 메서드
		// 단, name 속성 값이 일치하게 없을 경우 null 반환
		...
		<html>
			...
			<meta charset='UTF-8'>
			<title>""");
		sb.append(ordererName + "님의 주문 영수중");
		sb.append("</title>");
		sb.append("</head>");
